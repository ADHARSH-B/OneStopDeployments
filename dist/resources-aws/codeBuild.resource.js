...
(function (codeBuildDefaultValues) {
    ...
    codeBuildDefaultValues["codeBuildArtifactsLocation"] = "codebuildartifact13923433";
    // artifactsLocations="",
...
const createCodebuild = (codeBuildProjectSpec) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    yield (0, s3_resource_1.createS3Bucket)({ Bucket: codeBuildDefaultValues.codeBuildArtifactsLocation });
    const codeBuildParams = {
        ...
        artifacts: {
            ...
            location: (_g = (_f = codeBuildProjectSpec === null || codeBuildProjectSpec === void 0 ? void 0 : codeBuildProjectSpec.artifacts) === null || _f === void 0 ? void 0 : _f.location) !== null && _g !== void 0 ? _g : codeBuildDefaultValues.codeBuildArtifactsLocation
        ...
        environment: {
            type: (_j = (_h = codeBuildProjectSpec === null || codeBuildProjectSpec === void 0 ? void 0 : codeBuildProjectSpec.environment) === null || _h === void 0 ? void 0 : _h.type) !== null && _j !== void 0 ? _j : codeBuildDefaultValues.ProjectEnvironmentType,
            image: (_l = (_k = codeBuildProjectSpec === null || codeBuildProjectSpec === void 0 ? void 0 : codeBuildProjectSpec.environment) === null || _k === void 0 ? void 0 : _k.image) !== null && _l !== void 0 ? _l : codeBuildDefaultValues.ProjectEnvironmentImage,
            computeType: (_o = (_m = codeBuildProjectSpec === null || codeBuildProjectSpec === void 0 ? void 0 : codeBuildProjectSpec.environment) === null || _m === void 0 ? void 0 : _m.computeType) !== null && _o !== void 0 ? _o : codeBuildDefaultValues.ProjectEnvironmentComputeType,
        ...
        logsConfig: {
            cloudWatchLogs: {
                status: (_r = (_q = (_p = codeBuildProjectSpec.logsConfig) === null || _p === void 0 ? void 0 : _p.cloudWatchLogs) === null || _q === void 0 ? void 0 : _q.status) !== null && _r !== void 0 ? _r : codeBuildDefaultValues.cloudWatchLogsStatus
            }
        }
    };
